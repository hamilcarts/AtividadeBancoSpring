...
class PixTest {
    ...
    void pixPositivoQuebrado() {
        ...
        assertEquals(BigDecimal.valueOf(2.7), conta1.getSaldo(), "O saldo da conta deve ser alterado para 3");
        assertEquals(BigDecimal.valueOf(8.3), conta2.getSaldo(), "O saldo da conta deve ser alterado para 8");
